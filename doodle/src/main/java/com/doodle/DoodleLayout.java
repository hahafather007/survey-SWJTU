...
public class DoodleLayout extends FrameLayout implements View.OnClickListener {
    ...
    public DoodleLayout(@NonNull Context context) {
        this(context,null);
    }

    public DoodleLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public DoodleLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context,Bitmap bitmap) {
        rootView = LayoutInflater.from(context).inflate(R.layout.doodle_layout,null,false);
    ...
    private void initViewAction() {
        mBtnUndo = rootView.findViewById(R.id.btn_undo);
...
//                }
        ...
        mBtnHidePanel = rootView.findViewById(R.id.doodle_btn_hide_panel);

        mPaintSizeView = rootView.findViewById(R.id.paint_size_text);
        mShapeContainer = rootView.findViewById(R.id.shape_container);
        mPenContainer = rootView.findViewById(R.id.pen_container);
        ...
        mRedoBtn = rootView.findViewById(R.id.btn_redo);

        mBtnColor = rootView.findViewById(R.id.btn_set_color);
        mColorContainer = rootView.findViewById(R.id.btn_set_color_container);
    ...
    private void setOnClickListener(){
        rootView.findViewById(R.id.btn_pen_hand).setOnClickListener(this);
        rootView.findViewById(R.id.btn_pen_mosaic).setOnClickListener(this);
        rootView.findViewById(R.id.btn_pen_copy).setOnClickListener(this);
        rootView.findViewById(R.id.btn_pen_eraser).setOnClickListener(this);
        rootView.findViewById(R.id.btn_pen_text).setOnClickListener(this);
        rootView.findViewById(R.id.btn_pen_bitmap).setOnClickListener(this);
        rootView.findViewById(R.id.doodle_btn_brush_edit).setOnClickListener(this);
        rootView.findViewById(R.id.btn_undo).setOnClickListener(this);
        rootView.findViewById(R.id.btn_zoomer).setOnClickListener(this);
        rootView.findViewById(R.id.btn_set_color_container).setOnClickListener(this);
        rootView.findViewById(R.id.doodle_btn_hide_panel).setOnClickListener(this);
        rootView.findViewById(R.id.doodle_btn_finish).setOnClickListener(this);
        rootView.findViewById(R.id.doodle_btn_rotate).setOnClickListener(this);
        rootView.findViewById(R.id.doodle_btn_back).setOnClickListener(this);
        ...
        rootView.findViewById(R.id.btn_hand_write).setOnClickListener(this);
        rootView.findViewById(R.id.btn_arrow).setOnClickListener(this);
        rootView.findViewById(R.id.btn_line).setOnClickListener(this);
        rootView.findViewById(R.id.btn_holl_circle).setOnClickListener(this);
        rootView.findViewById(R.id.btn_fill_circle).setOnClickListener(this);
        rootView.findViewById(R.id.btn_holl_rect).setOnClickListener(this);
        rootView.findViewById(R.id.btn_fill_rect).setOnClickListener(this);
        ...
        rootView.findViewById(R.id.btn_redo).setOnClickListener(this);
    }
...
//        });
    ...
    private class DoodleViewWrapper extends DoodleView {
        ...
        public void enableZoomer(boolean enable) {
            ...
            rootView.findViewById(R.id.btn_zoomer).setSelected(enable);
            if (enable) {
        ...
        View mBtnEditMode = rootView.findViewById(R.id.doodle_btn_brush_edit);
