package com.android.framekit.view.activity
...
abstract class BaseActivity<in V : BaseContract.BaseView, P : BaseContract.BasePresenter<V>> : AppCompatActivity() {
    ...
    /*-----------------------------activity ui api start-----------------------------------*/


    open fun setActivityStyle() {
        setStatusBarLightMode(true)
        setStatusBarColor(true, ContextCompat.getColor(this, R.color.white))
        if (actionBar != null) {
            actionBar!!.hide()
        }
